 ...
 * CryptoColors.kt
 *
 * Defines the custom dark theme color system for the Valguard application.
 * This file contains semantic color tokens that provide consistent theming
 * across the entire app.
 *
 * Valguard is a dark-theme-only application, optimized for financial
...
/**
 * Data class containing all color tokens for the Valguard design system.
 *
...
/**
 * Dark theme color palette for Valguard.
 *
