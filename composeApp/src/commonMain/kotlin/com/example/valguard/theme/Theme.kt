 ...
 * Theme.kt
 *
 * Main theme configuration file for the Valguard application.
 * This file sets up the Material 3 dark theme for the app.
 *
 * Valguard is a dark-theme-only application, optimized for:
 ...
 * - Custom Valguard design tokens (colors, typography, spacing, shapes)
...
/**
 * Material 3 dark color scheme for Valguard.
 *
...
/**
 * Main theme composable for the Valguard application.
 *
